			...
			<div class="report_left">
				...
				<?php print form::input('incident_title', $form['incident_title'], ' class="text long"'); ?>		
							...
							<?php else: ?>
								...
								<h1>Post Activities/ Openings</h1>
									<div class="report_row">
				...
				<div class="report_row">
					...
					<?php
						...
						echo category::tree($categories, TRUE, $selected_categories, 'incident_category',$name1, 2);
						?>
					</div>
				</div>
