	...
	<div class="content-bg">
		...
		<div class="big-block">
			...
			<div class="step-2-holder">
				<div class="step-2">
					...
					<div class="holder">
						...
						<div class="box">
							...
							<span><?php print form::input('alert_email', $form['alert_email'], ' class="long2"'); ?></span>
						</div>
					</div>
				</div>
				<div class="step-3">
					...
					<div class="holder">
						<div class="box">
							...
							<?php 
								...
								echo category::tree($categories, TRUE, $selected_categories, 'alert_category',1, TRUE);
					...
					<div class="holder">
						...
						<div class="box">
							...
							<?php 
								...
								echo category::tree($categories, TRUE, $selected_categories, 'alert_category',3, TRUE);
				...
				<BR />(Please wait as creating an alert request takes sometime)<BR />
