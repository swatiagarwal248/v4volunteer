...
class ngo_Controller extends Main_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->header->this_page = 'ngo';
        $this->template->content = new View('ngo');

        $this->template->header->page_title .= Kohana::lang('ui_main.ngo').Kohana::config('settings.title_delimiter');
