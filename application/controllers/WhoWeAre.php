...
class WhoWEAre_Controller extends Main_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->header->this_page = 'WhoWeAre';
        $this->template->content = new View('WhoWeAre');

        $this->template->header->page_title .= Kohana::lang('ui_main.WhoWeAre').Kohana::config('settings.title_delimiter');
