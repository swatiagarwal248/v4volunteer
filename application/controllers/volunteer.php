...
class volunteer_Controller extends Main_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->header->this_page = 'volunteer';
        $this->template->content = new View('volunteer');

        $this->template->header->page_title .= Kohana::lang('ui_main.volunteer').Kohana::config('settings.title_delimiter');
