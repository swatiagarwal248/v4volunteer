...
class OurMission_Controller extends Main_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->header->this_page = 'OurMission';
        $this->template->content = new View('OurMission');

        $this->template->header->page_title .= Kohana::lang('ui_main.OurMission').Kohana::config('settings.title_delimiter');
