...
class WhyAreWeDifferent_Controller extends Main_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->header->this_page = 'WhyAreWeDifferent';
        $this->template->content = new View('WhyAreWeDifferent');

        $this->template->header->page_title .= Kohana::lang('ui_main.WhyAreWeDifferent').Kohana::config('settings.title_delimiter');
