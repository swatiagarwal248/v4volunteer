...
class HowItWorks_Controller extends Main_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->header->this_page = 'HowItWorks';
        $this->template->content = new View('HowItWorks');

        $this->template->header->page_title .= Kohana::lang('ui_main.HowItWorks').Kohana::config('settings.title_delimiter');
