...
class Privacy_Controller extends Main_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->header->this_page = 'privacy';
        $this->template->content = new View('privacy');

        $this->template->header->page_title .= Kohana::lang('ui_main.privacy').Kohana::config('settings.title_delimiter');
