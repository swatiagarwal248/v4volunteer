...
class OurPhilosophy_Controller extends Main_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->header->this_page = 'OurPhilosophy';
        $this->template->content = new View('OurPhilosophy');

        $this->template->header->page_title .= Kohana::lang('ui_main.OurPhilosophy').Kohana::config('settings.title_delimiter');
